(() => {
  ...
  const pairs = [
    ...
    ['2~24자 별명', 'Nickname, 2–24 characters'],
    ['저장', 'Save'],
    ['VAULT ID는 바뀌지 않으며 별명과 함께 표시됩니다.', 'Your VAULT ID stays unchanged and appears with your nickname.'],
    ['사람 찾기', 'Find people'],
    ['VAULT ID 또는 별명 검색', 'Search VAULT ID or nickname'],
    ['조직 구성원을 불러오는 중', 'Loading organization members'],
    ['조직 구성원을 불러오고 있습니다.', 'Loading organization members.'],
    ['목록 새로고침', 'Refresh list'],
    ['인증과 기기 키 준비를 기다리고 있습니다.', 'Waiting for identity and device keys.'],
    ['대화를 선택하세요', 'Choose a conversation'],
    ['같은 조직의 구성원을 선택하면 대화를 시작할 수 있습니다.', 'Choose a member in your organization to start messaging.'],
    ...
    ['파일 선택', 'Select file'],
    ['파일별 키 · 기기 암호화', 'Per-file key · Device wrapped'],
    ['최대 10MB · 브라우저 암호화', 'Maximum 10 MB · Client-side encryption'],
    ['비공개 · 암호문만', 'Private / Ciphertext only'],
    ['파일별 · 기기 암호화', 'Per item / Device wrapped'],
    ['암호문 영구 보관', 'Persistent ciphertext'],
    ['파일 암호화', 'Encrypt file'],
    ['복호화 다운로드', 'Decrypt'],
    ['접근키 폐기', 'Revoke'],
